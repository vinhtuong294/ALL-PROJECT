...
import '../../../../../../core/widgets/shipper_tracking_map.dart';
    ...
    return SingleChildScrollView(
      child: Column(
        children: [
          ...
          // 🚐 TRACKING MAP - hiện khi đơn hàng đang giao
          if (orderDetail.tinhTrangDonHang == 'dang_giao')
            Padding(
              ...
              child: Container(
                ...
                child: ShipperTrackingMap(
                  orderId: orderDetail.maDonHang,
                  deliveryAddress: orderDetail.diaChiGiaoHang?.address,
                ),
              ),
            ),
