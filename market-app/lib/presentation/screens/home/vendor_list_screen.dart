      ...
      child: Container(
        ...
        child: Row(
          children: [
            ...
            _StatusBadge(merchant: merchant),
...
class _StatusBadge extends StatelessWidget {
  final MerchantModel merchant;
  const _StatusBadge({required this.merchant});

  @override
  Widget build(BuildContext context) {
    String label = 'Tạm nghỉ';
    Color bgColor = const Color(0xFFFEE2E2);
    Color textColor = const Color(0xFFDC2626);
    
    if (merchant.isPending) {
      label = 'Chờ duyệt';
      bgColor = const Color(0xFFFEF3C7); // Yellow/Orange bg
      textColor = const Color(0xFFD97706); // Amber/Orange text
