...
if ! command -v ollama &>/dev/null; then
    ...
    if ollama list 2>/dev/null | grep -q "llama3.2"; then
        echo "✅ Model llama3.2 sẵn sàng."
    else
        echo "⬇️  Đang tải llama3.2 (khoảng 2GB, vui lòng chờ)..."
...
# 6. Khởi động FastAPI
echo ""
echo "🚀 Khởi động API tại http://207.180.233.84:8000"
echo "📖 Swagger UI: http://207.180.233.84:8000/docs"
echo "════════════════════════════════════════════"
echo ""
