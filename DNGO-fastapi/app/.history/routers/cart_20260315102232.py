...
def update_item(
    ...
    cart_detail = CartRepository.update_item(
        db,
        cart_id,
        ingredient_id,
        stall_id,
...
def checkout(
    ...
    return CartRepository.checkout(db, buyer_id, body)
