...
class User(Base):
    ...
    approval_status = Column(SmallInteger, default=1, server_default='1')
...
class OrderDetail(Base):
    ...
    __table_args__ = (
        CheckConstraint(
            "detail_status IN ('cho_duyet', 'da_duyet', 'tu_choi', 'huy_hang', 'hoan_hang', 'da_lay_hang')",
            name="check_detail_status"
        ),
    )
